...
export function SectionCards() {
  ...
  return (
    <div
      ...
      {loading ? ([...Array(4)].map((_, idx) => <LoadingSkeleton key={idx} />)
      ) : (
        <>
          ...
          <Card className="@container/card">
            <CardHeader>
              ...
              <CardAction>
                <Badge variant="outline">
                  <IconTrendingUp />
                  {Number(data?.twoWeeks?.count).toFixed(2) ?? 0}
                </Badge>
              </CardAction>
            </CardHeader>
            <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <Card className="@container/card">
            <CardHeader>
              ...
              <CardAction>
                <Badge variant="outline">
                  <IconTrendingUp />
                  {Number(data?.month?.count).toFixed(2) ?? 0}
                </Badge>
              </CardAction>
            </CardHeader>
            <CardFooter className="flex-col items-start gap-1.5 text-sm">
          ...
          <Card className="@container/card">
            <CardHeader>
              ...
              <CardAction>
                <Badge variant="outline">
                  <IconTrendingUp />
                  {Number(data?.lastMonth?.count).toFixed(2) ?? 0}
                </Badge>
              </CardAction>
            </CardHeader>
            <CardFooter className="flex-col items-start gap-1.5 text-sm">
